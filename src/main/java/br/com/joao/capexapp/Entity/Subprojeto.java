...
public class Subprojeto {
  ...
  @OneToMany(mappedBy = "subprojeto", cascade = CascadeType.ALL, fetch = FetchType.LAZY)
  private List<NaturezaGasto> naturezaGastos = new ArrayList<>();

  public List<NaturezaGasto> getNaturezaGastos() {
    return naturezaGastos;
  }

  public void setNaturezaGastos(List<NaturezaGasto> naturezaGastos) {
